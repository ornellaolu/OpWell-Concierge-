  ...
  try {
    if (action === 'get-schedule') {
      ...
      try {
        ...
        console.log('✅ Dr. Oluwole notification sent successfully');
      } catch (drErr) {
        console.error('⚠️ Failed to send Dr. Oluwole notification:', drErr.message);
      }
      ...
      try {
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #2c2c2c;">
              ...
              <div style="padding: 40px; background: #fdf8f4;">
                ...
                <div style="text-align: center; margin: 24px 0;">
                  <a href="https://www.opwellconcierge.com/recovery-checkin?token=${patientRecord ? encodeURIComponent(patientRecord.token) : ''}" style="display: inline-block; background: #2d5a3d; color: #fff; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px;">📋 Submit Your First Check-In</a>
                </div>
        ...
        console.error('⚠️ Failed to send patient email:', patErr.message);
      }
          ...
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #2c2c2c;">
              ...
              <div style="padding: 40px; background: #fdf8f4;">
                ...
                <div style="text-align: center; margin: 24px 0;">
                  <a href="https://www.opwellconcierge.com/recovery-checkin?token=${patientToken ? encodeURIComponent(patientToken) : ''}&interval=${interval}" style="display: inline-block; background: #2d5a3d; color: #fff; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px;">📋 Submit Your Check-In Now</a>
                </div>
      ...
      return res.status(200).json({
        ...
        checkinUrl: `https://www.opwellconcierge.com/recovery-checkin?token=${patientToken ? encodeURIComponent(patientToken) : ''}&interval=${interval}`
      });
